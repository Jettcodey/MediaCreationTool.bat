...
:Universal MCT wrapper script for all Windows 10/11 versions from 1507 to 25H2 by AveYo Updated by Jettcodey!
...
:: on upgrade: latest build, on offline install: 11 25H2 26200.7623/ 11 24H2 26100.4349 / 11 23H2 22631.2861 / 11 22H2 22621.1702 / 11 21H2 22000.318 / 22H2 19045.3803 / 21H2 19044.1288 / 21H1 19043.1348 / 20H2 19042.1052
...
for %%V in (1.1507 2.1511 3.1607 4.1703 5.1709 6.1803 7.1809 8.1903 8.19H1 9.1909 9.19H2 10.2004 10.20H1 11.2009 11.20H2 12.2104
 12.21H1 13.2109 13.21H2 14.2210 14.22H2 15.2110 15.11_21H2 16.2209 16.11_22H2 17.2310 17.11_23H2 18.2410 18.11_24H2 19.11_25H2) do for %%s in (%MCT% %~n0 %*) do if /i %%~xV equ .%%~s set "MCT=%%~nV" & set "VID=%%~s"
...
:choice-19
set "VER=26200" & set "VID=11_25H2" & set "CB=26200.7623.260109-1650.25h2_ge_release_svc_refresh" & set "CT=2026/01/" & set "CC=2.0"
set "XML=https://mct-files.de/11-25H2/products-25H2.xml"
set "EXE=https://mct-files.de/11-25H2/mediacreationtool.exe"
...
reg add "HKLM\SOFTWARE\Microsoft\Windows NT\CurrentVersion\AppCompatFlags\HwReqChk" /f /v HwReqChkVars /t REG_MULTI_SZ /d "SQ_SecureBootCapable=TRUE\0SQ_SecureBootEnabled=TRUE\0SQ_TpmVersion=2\0SQ_RamMB=8192" /reg:64 >nul 2>nul &rem ::# 24/25H2
